<script>
import NewImaginaryDimensionRow from "./ModernImaginaryDimensionRow";
import PrimaryButton from "@/components/PrimaryButton";

export default {
  name: "NewImaginaryDimensionsTab",
  components: {
    PrimaryButton,
    NewImaginaryDimensionRow
  },
  data() {
    return {
      totalUpgrades: 0,
  ...
  methods: {
    update() {
      ...
      this.shardsPerSecond.copyFrom(ImaginaryDimension(1).productionPerSecond);
